...
public class GATestFlow : GAScript
{
    ...
    protected override void generationRan()
    {
        ...
        debug = "Generation:" + m_ga.GenerationsNumber + " - Fitness:" + fitnessDebug + " - Fitness Max:" + bestFitness; 
        //Debug.Log(debug);
#if LOGGER
        ...
        if (fitnessDebug > bestFitness)
        {
            ...
            bestResult = (Module[,])gridResult.Clone();
        }
    ...
    public class WFCChromosome : ChromosomeBase
    {
        ...
        {
            return new Gene(RandomizationProvider.Current.GetInt(0, (UniqueTile.getLastId()) * 4));
        }
    ...
    public class WFCFitness : IFitness
    {
        ...
        public double Evaluate(IChromosome chromosome)
        {
            ...
            int nbSteps = m_gridSize.x * m_gridSize.y * 5;
            for (int i = 0; i < nbSteps; i++)
                fitness += agent.Step() / (float)nbSteps;
