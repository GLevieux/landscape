...
namespace GeneticSharp.Domain.Crossovers
{
    ...
    public class MyTwoPointCrossover : OnePointCrossover
    {
        #region Constructors
        /// <summary>
        ...
        public MyTwoPointCrossover(int swapPointOneGeneIndex, int swapPointTwoGeneIndex, double crossoverProbability)
        {
        ...
        /// Initializes a new instance of the <see cref="GeneticSharp.Domain.Crossovers.TwoPointCrossover"/> class.
        /// </summary>
        public MyTwoPointCrossover() : this(0, 1 ,0.5)
        {
        }
        #endregion
        ...
        {
            SwapPointOneGeneIndex = RandomizationProvider.Current.GetInt(0, leftParent.Length-1);
            SwapPointTwoGeneIndex = SwapPointOneGeneIndex + RandomizationProvider.Current.GetInt(0, leftParent.Length - SwapPointOneGeneIndex-1);
